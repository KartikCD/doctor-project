                    ...
                    public void onResponse(Call<LoginParserDemo> call, Response<LoginParserDemo> response) {
                        ...
                        if(status.equals("SUCCESS"))
                        {
                            ...
                            if (type.equals("assistantDoctor")) {
                                sessionManager.createLoginSession(response.body().getUsername().toString(),response.body().getOid().toString(), type, response.body().getDoctid(), password);
                            } else {
                                sessionManager.createLoginSession(response.body().getUsername().toString(),response.body().getOid().toString(), type, "", password);
                            }
